...
// ✅ Importer dynamiquement les composants qui utilisent window
const MissionCard = dynamic(
  () => import("@/components/missions/Card/MissionCard"),
  { ssr: false },
);
const ApplicationModal = dynamic(
  () => import("@/components/missions/Form/ApplicationModal"),
  { ssr: false },
);
const CreateMissionModal = dynamic(
  () => import("@/components/missions/Form/CreateMissionModal"),
  { ssr: false },
);
const MissionDetailModal = dynamic(
  () => import("@/components/missions/Card/MissionDetailCard"),
  { ssr: false },
);
const MissionFilters = dynamic(
  () => import("@/components/missions/MissionFilters"),
  { ssr: false },
);
const EmptyMissions = dynamic(
  () => import("@/components/missions/EmptyMission"),
  { ssr: false },
);
  ...
  return (
    <div className="w-full min-h-screen mx-auto p-4 sm:p-6 md:p-8 lg:p-12 pb-24 md:pb-6 max-w-[1440px]">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-8 md:mb-12">
        <div className="bg-white/70 backdrop-blur-sm border border-[#c2c9bb]/30 rounded-xl sm:rounded-2xl p-3 sm:p-4 flex items-center gap-2 sm:gap-3">
