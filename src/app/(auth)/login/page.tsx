  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:flex flex-col justify-between px-16 py-14 lg:w-[48%] relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-2.5">
          <Leaf
            ...
            strokeWidth={2.5}
          />
          <span className="font-bold text-[18px]" style={{ color: "#047857" }}>
            AgriPulse
          </span>
        </div>
        <div className="relative z-10">
          <h1
            ...
            style={{ fontSize: 52, color: "#042f20", letterSpacing: "-0.02em" }}
          >
            Plateforme
            <br />
            Agricole
            <br />
            <span style={{ color: "#059669" }}>Communautaire</span>
            <span className="inline-block ml-3 text-4xl">
              <TreesIcon />
            </span>
          </h1>
          <p
            ...
            style={{ color: "#1a5c3a" }}
          >
            Partagez vos expériences, découvrez de nouvelles pratiques et
            connectez-vous avec d'autres agriculteurs pour améliorer vos
            rendements.
          </p>
        </div>
        <p className="relative z-10 text-[13px]" style={{ color: "#3d7a5e" }}>
          © 2026 AgriPulse{" "}
        </p>
      </div>
      ...
      <div
        ...
        style={{
          background: "linear-gradient(180deg, #f0fdf8 0%, #e8faf2 100%)",
        }}
      >
        <div className="w-full max-w-[420px]">
          ...
          <div className="flex justify-center mb-6">
            <div
              ...
              style={{ boxShadow: "0 8px 24px rgba(5,150,105,0.28)" }}
            >
              <img
          ...
          <div
            ...
            style={{
              boxShadow:
                "0 16px 48px rgba(0,80,50,0.10), 0 2px 8px rgba(0,80,50,0.06)",
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <label className="flex items-center gap-2.5 cursor-pointer">
                <div className="relative">
                  ...
                  <div
                    ...
                    style={{
                      borderColor: rememberMe ? "#059669" : "#a8d5bc",
                ...
                <span className="text-[13px]" style={{ color: "#5a8a72" }}>
                  Se souvenir de moi
                </span>
              </label>
              ...
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{ background: "#d4edd9" }}
                />
                <span className="text-[13px]" style={{ color: "#9ab8ac" }}>
                  ou continuer avec
                </span>
                <div
                  className="flex-1 h-px"
              ...
              {/* ✅ Bouton Google OAuth actif */}
              <button
                type="button"
                onClick={handleGoogleLogin}
                disabled={isGoogleLoading}
                className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl text-[14px] font-medium transition-all active:scale-[0.98] hover:bg-gray-50 disabled:opacity-70"
                style={{
                  border: "1.5px solid #d4edd9",
                  color: "#2d4a3e",
                  boxShadow: "0 2px 8px rgba(0,80,40,0.06)",
