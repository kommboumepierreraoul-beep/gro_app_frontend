  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <div className="hidden lg:flex flex-col justify-between px-16 py-14 lg:w-[48%] relative overflow-hidden">
        ...
        {/* Dégradé : image claire en haut → vert opaque en bas */}
        <div
        ...
        <div className="relative z-10 flex items-center gap-2.5">
          ...
          <span className="text-[18px] font-bold" style={{ color: '#047857' }}>AgriTech</span>
        </div>
        ...
        <div className="w-full max-w-[420px]">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div
                  ...
                  style={{ background: '#edfaf3', border: '1.5px solid #b8e8d0', height: 52 }}
                >
                  <svg className="w-[18px] h-[18px] flex-shrink-0" style={{ color: '#7ab89a' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="/forgot-password" className="text-[13px] font-semibold" style={{ color: '#059669' }}>
                  Mot de passe oublié ?
                </a>
              </div>
              ...
              <button
                ...
                style={{ background: 'linear-gradient(135deg, #059669 0%, #047857 100%)', boxShadow: '0 4px 20px rgba(5,150,105,0.30)' }}
              >
                {isLoading ? (
            ...
            <div className="text-center mt-7">
              <p className="text-[13px]" style={{ color: '#6aab87' }}>Vous n'avez pas encore de compte ?</p>
              <button
                type="button"
                className="mt-3 px-8 py-2.5 rounded-full text-[14px] font-bold transition-all active:scale-[0.97]"
