...
export default function AdminUsersPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-7rem)] rounded-2xl border border-[#c2c9bb]/30 bg-[#f9faf2] text-[#002118] selection:bg-primary-container selection:text-on-primary-container p-4 sm:p-6 lg:p-8">
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div className="glass-card premium-shadow p-6 rounded-lg relative overflow-hidden group hover:scale-[1.02] transition-transform duration-300 card-green-shadow-left">
      ...
      <div className="flex items-end gap-3">
        ...
        <span className="mb-1.5 text-xs font-bold text-emerald-500 flex items-center">
          <TrendingUp className="mr-1 h-4 w-4" /> 4%
        </span>
      </div>
    </div>
    ...
    <div className="glass-card premium-shadow p-6 rounded-lg border-l-4 border-emerald-500 relative overflow-hidden group hover:scale-[1.02] transition-transform duration-300 card-green-shadow-left">
      ...
      <div className="flex items-end gap-3">
        ...
        <Clock3 className="mb-1.5 h-5 w-5 animate-pulse text-error" />
      </div>
    </div>
  </div>
</section>
              ...
              >
                ...
                <div className="flex items-center justify-between mt-2">
                  <div className="flex gap-2">
                    ...
                    >
                      {user.status === 'active' ? <PauseCircle className="h-[18px] w-[18px]" /> : <PlayCircle className="h-[18px] w-[18px]" />}
      ...
      <nav className="md:hidden sticky bottom-3 mt-8 bg-surface/90 backdrop-blur-xl border border-outline-variant/30 py-3 px-4 flex justify-around items-center z-40 rounded-xl shadow-[0_8px_30px_rgba(6,44,34,0.08)]">
