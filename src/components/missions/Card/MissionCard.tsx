...
function getAuthorName(author?: Mission["author"]): string {
  ...
  const firstName = author.firstname ?? (author as { name?: string }).name;
        ...
        <article className="border border-gray-100 rounded-2xl p-6 flex flex-col hover:shadow-lg transition-all duration-300 group hover:border-green-200 h-full">
          ...
          <div className="flex gap-2 mt-auto">
            <button
              ...
              className="flex-1 py-3 border border-green-950 text-green-950 font-semibold text-xs tracking-widest uppercase rounded-xl hover:bg-green-950 hover:text-white transition-all duration-200 text-center"
            >
              Voir les détails
            </button>
            {mission.status === "published" && (
